...
class _AddContactSheetState extends State<AddContactSheet> {
  ...
  void initState() {
    ...
    if (widget.contact != null) {
      ...
      _phoneController.text = p.isNotEmpty ? _normalizeUzPhone(p) : '+998';
    }
    ...
    _phoneController.addListener(() {
      ...
      if (t.length < 4) _setPhoneText('+998');
    });
  }
